    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPreferences != null){
            ...
            if(selectedVisaId == 0){
                ...
                visaName.setText(sharedPreferences.getString("applied_visa",""));
...
//                    Log.v(TAG_REGISTER, resp);
    ...
    private void singaporeApplicantData(String resp){
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("profession_id", professionId)
                .addFormDataPart("highest_qualification", highestQualification)
                ...
                .addFormDataPart("flag", String.valueOf(0))
