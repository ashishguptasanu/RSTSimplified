...
public class UsaVisaAdapter3 extends RecyclerView.Adapter<UsaVisaAdapter1.MyViewHolder> {
    private List<VisaType_> visaTypes1 = new ArrayList<>();
    Context context;

    public UsaVisaAdapter3(Context context, List<VisaType_> visaTypes1){
